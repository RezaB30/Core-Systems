function SetupIPSubnetList(containersId) {
    var containers = $(containersId);

    containers.each(function () {
        var container = $(this);

        var modelNameContainer = container.find('#ip-netmap-model-name');
        var modelName = modelNameContainer.val();
        var form = container.closest('form');
        var sampleRows = container.find('tr.ip-netmap-list-sample-row');
        ...
        form.submit(function () {
            container.find('.ip-netmap-list-sample-row').remove();
            rearrangeNames();
        });
        ...
        addButton.click(function () {
            ...
            addedRows.removeClass('ip-netmap-list-sample-row')
        ...
        function rearrangeNames() {
            var validRows = container.find('tr.ip-netmap-list-row:not(.ip-netmap-list-sample-row)');
