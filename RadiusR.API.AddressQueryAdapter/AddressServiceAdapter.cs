...
{
    public class AddressServiceAdapter : IAddressQuery
    {
        ...
        public RadiusAddress<AddressDetails> GetApartmentAddress(long apartmentId)
        {
            try
            {
                ...
                return new RadiusAddress<AddressDetails>()
                {
                    ErrorOccured = !results.IsSuccess,
                    ErrorMessage = results.ErrorMessage,
                    Data = results.IsSuccess ? new AddressDetails()
                    {
                        AddressNo = results.Results.AddressNo,
                        AddressText = results.Results.AddressText,
                        ApartmentID = results.Results.ApartmentID,
                        ApartmentNo = results.Results.ApartmentNo,
                        DistrictID = results.Results.DistrictID,
                        DistrictName = results.Results.DistrictName,
                        DoorID = results.Results.DoorID,
                        DoorNo = results.Results.DoorNo,
                        NeighbourhoodID = results.Results.NeighbourhoodID,
                        NeighbourhoodName = results.Results.NeighbourhoodName,
                        ProvinceID = results.Results.ProvinceID,
                        ProvinceName = results.Results.ProvinceName,
                        RuralCode = results.Results.RuralCode,
                        StreetID = results.Results.StreetID,
                        StreetName = results.Results.StreetName
                    } : null
                };
            }
            catch (Exception ex)
